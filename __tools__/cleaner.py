...
def main():
    ...
    #    os.path.join(project_root, '__files__/export'),
    #    os.path.join(project_root, '__files__/metrics'),
    #    os.path.join(project_root, '__files__/predict'),
    #    os.path.join(project_root, '__files__/read_files'),
    #    os.path.join(project_root, '__files__/scan_files'),
    #    os.path.join(project_root, '__files__/reports'),
